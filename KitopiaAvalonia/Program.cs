...
internal class Program
{
    ...
    private static IServiceProvider ConfigureServices()
    {
        ...
        services.AddSingleton<IMessageCodec, ImageChatMessageCodec>();
        services.AddSingleton<IMessageCodec, FileChatMessageCodec>();
        services.AddSingleton<IMessageCodec, FileOfferChatMessageCodec>();
        services.AddSingleton<IMessageCodec, FileAcceptChatMessageCodec>();
        services.AddSingleton<IMessageCodec, FileRejectChatMessageCodec>();
        services.AddSingleton<IMessageCodec, FileCompleteChatMessageCodec>();
        services.AddSingleton<IMessageCodec, FileCancelChatMessageCodec>();
