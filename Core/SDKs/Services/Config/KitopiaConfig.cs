...
public class KitopiaConfig : ConfigBase
{
    ...
    [ConfigFieldCategory("搜索框")] [ConfigField("搜索框快捷键", "显示搜索框快捷键", 0xF4B8, ConfigFieldType.快捷键,action:"searchHotKeyAction")]
    ...
    public override void BeforeLoad()
    {
        ...
        {
            log.Debug("截图热键被触发");
            var captureAllScreen = ServiceManager.Services.GetService<IScreenCaptureManager>()!.CaptureAllScreenBitmap();
        ...
        invokes.Add("截图方法列表",new Func<IEnumerable<string>>(() =>
        {
