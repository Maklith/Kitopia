...
public sealed class ClipboardRouteHandler : IRouteHandler
{
    private readonly MessageCodecRegistry _codecRegistry;
    private readonly IIncomingMessageSink _incomingMessageSink;

    public ClipboardRouteHandler(MessageCodecRegistry codecRegistry, IIncomingMessageSink incomingMessageSink)
    {
