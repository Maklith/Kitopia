...
using ValueType = Kitopia.Desktop.Windows.TaskEditors.ValueType;
...
public class TaskEditorValueToolTipCtr : IMultiValueConverter
{
    public object? Convert(IList<object?> values, Type targetType, object? parameter, CultureInfo culture)
    {
        ...
        CustomScenarioModel? third =
            values.FirstOrDefault(e => e != null && e.GetType() == typeof(CustomScenarioModel)) as CustomScenarioModel;
