...
public class NodeInputDataTemplateSelector : IDataTemplate
{
    ...
    ResourceInclude Templates { get; } =
        new ResourceInclude(new Uri("avares://Kitopia.Desktop/Windows/TaskEditors/NodeInputTemplates.axaml"))
        {
            Source = new Uri("avares://Kitopia.Desktop/Windows/TaskEditors/NodeInputTemplates.axaml")
        };
